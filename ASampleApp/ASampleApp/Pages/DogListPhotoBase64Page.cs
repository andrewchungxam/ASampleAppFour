...
namespace ASampleApp.Pages
{
	public class DogListPhotoBase64Page : BaseContentPage<DogListPhotoBase64ViewModel>
	{
		...
		public DogListPhotoBase64Page()
		{
			...
			var myTemplate = new DataTemplate(typeof(DogPhotoBase64ViewCell));
			_dogListView.ItemTemplate = myTemplate;
	...
	public class DogPhotoBase64ViewCell : ViewCell
	{
		MenuItem _deleteAction;

		public DogPhotoBase64ViewCell()
		{
            ...
            dogImage.SetBinding(Image.SourceProperty, nameof(model.DogPictureSource), BindingMode.OneWay, new Base64ToImageSourceConverter());
